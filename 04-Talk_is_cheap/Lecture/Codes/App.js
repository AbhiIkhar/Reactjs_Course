      ...
      <div className="res-container">
        {
          ...
          // Config driven UI
          // You should pass key when u apply loop over list to identify each obj uniquely.
          // Why ? -- Go on notes
        }
      </div>
    </div>
...
/*
whaterver properties which u pass in restaurant card in our case 
it is resData at time of destructing in our card we have to use that
same property (key)--resData
